...
export default function PartnerLogin() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const response = await axios.post(import.meta.env.VITE_FOOD_PARTNER_LOGIN_API, formData, { withCredentials: true});
            setformData({
                email: "",
                password: "",
            });
        ...
        <form onSubmit={handleSubmit} className="w-full h-163 p-10 bg-[#fafafaea] rounded-tl-[10vh]">
            ...
            <div className="mt-25 text-center">
                <h1 className="font-semibold">
                    Don't have any partner account ? <Link to="/foodpartner/register" className="underline">Sign up</Link>
                </h1>
                <h1 className="font-semibold">
